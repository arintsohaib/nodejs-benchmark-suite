...
**Current position (check TASKS/README if stale):** **`1.1.0-rc.1` prepared** (S19–S26 + release polish). Previous stable: **`1.0.0`**. Next: hardware validation → final `1.1.0` (no feature milestones until RC approved).
